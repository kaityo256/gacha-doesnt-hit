...
ルールは完全に分かっているのに、その結果を想像するのが難しい例として、シャーレの中のバクテリアの数のシミュレーションをしてみましょう。シャーレの培地にバクテリアを発生させます。このバクテリアは、一定期間ごとに子孫を残して死にます。また、このシャーレに住めるバクテリアの最大値は決まっているものとします。

培地の栄養価が高いほど子どもをたくさん残せますが、バクテリアの個体数が多いと子どもをほとんど残せません。もし現在の個体数が、シャーレに住める個体数の最大値に比べて十分少なければ、このバクテリアは周りを気にせず子どもを残すことができます。一方、現在の個体数

これを数式で表してみましょう。$i$世代目のバクテリアの個体数を$N_i$とします。このシャーレに住める個体数の最大値を$N_\mathrm{max}$としましょう。もしも、現在の個体数$N_i$が、最大の個体数$N_\mathrm{max}$に比べて十分少なければ、このバクテリアは周りを気にせず一匹あたり$a$匹の子どもを残します。ただし$a$は培地の栄養価に依存する比例係数です。一方、もし現在の個体数$N_i$が、最大の個体数$N_\mathrm{max}$に近ければ、ほとんど子どもを残すことができません。これを式で表すと、
...
この培地の栄養価が高いほど子どもをたくさん残せるが、バクテリアの個体数が多いほど
