...
$i$世代目のバクテリアの個体数を$N_i$とします。このシャーレに住める個体数の最大値を$N_\mathrm{max}$としましょう。もしも、現在の個体数$N_i$が、最大の個体数$N_\mathrm{max}$に比べて十分少なければ、このバクテリアは周りを気にせず一匹あたり$a$匹の子どもを残します。ただし$a$は培地の栄養価に依存する比例係数で、栄養価が高いほど大きな値を持ちます。一方、もし現在の個体数$N_i$が、個体数の上限値$N_\mathrm{max}$に近ければ、ほとんど子どもを残すことができません。以上から、次のような関係式を考えることができます。
