...
この時、コンピュータの中でサイコロを振る、乱数シミュレーションと呼ばれる手法を使うことで、何度も試して確率を見積もることができます。そして、その結果を見て、「こうなりそうだな」と見通しを得てから考えると、数学的に正しい答えに行き着きやすくなります。このように、数値シミュレーションは直感ではわかりにくい確率の問題を理解するための強力な道具として使えます。
