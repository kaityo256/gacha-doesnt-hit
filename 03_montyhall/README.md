...
図3に、クラスの人数と「同じ誕生日の人がいる確率」を計算するコードを示します。N人のクラスをランダムに10000回作り、そのうち何回で「クラスに同じ誕生日の二人」がいるかを計算します。それを人数を変えながら増やしていくプログラムです。
...
for i in range(10, 30):
    ...
    print(f"N = {i}, Probability = {probability}")
```
